...
export const serializeDistrict = (district) => ({
...
export const serializeTripOrder = (tripOrder) => ({
...
export const serializeExpenseEntry = (entry) => ({
    id: getId(entry._id),
    expense_category: {
...
export const serializeDailyBox = (dailyBox) => ({
