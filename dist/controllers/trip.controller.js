...
export class TripController {
    ...
    async assignableOrders(req, res) {
        const search = typeof req.query.search === "string" ? req.query.search : undefined;
    ...
    async assignOrders(req, res) {
        const orderIds = Array.isArray(req.body.order_ids) ? req.body.order_ids.map((id) => String(id)) : [];
    ...
    async updateTripOrderStatus(req, res) {
        const status = assertEnumValue(req.body.status, Object.values(TripOrderStatus), "status");
        const tripData = await tripService.updateTripOrderStatus(String(req.params.id), String(req.params.tripOrderId), {
            status,
