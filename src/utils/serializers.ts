...
export const serializeStatement = (statement: any) => ({
...
export const serializeResourceWithBalance = (resourceWithBalance: any) => ({
  user: {
...
export const serializePendingStatementOrder = (order: any) => ({
  id: getId(order._id),
  number: order.number,
  client_name: order.client_name,
  client_phone: order.client_phone,
